...
import com.dkl.gateway.fallback.DklGatewayBlockFallbackProvider;
...
/**
 * @author: dalele
 * @date: 2020/3/19 02:18
 * @description:限流
 */
@Slf4j
@Configuration
public class DklGatewaySentinelFilter {
	...
	@PostConstruct
	public void doInit() {
		ZuulBlockFallbackManager.registerProvider(new DklGatewayBlockFallbackProvider());
		initGatewayRules();
	}
